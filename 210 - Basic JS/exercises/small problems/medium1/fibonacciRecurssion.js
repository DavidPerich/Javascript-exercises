...
// input: an integer
// output. an integer
  // in which the output is the number in teh fibonacci sequence that the input would produce.

// fibonacci sequence rules
// first two values are always 1, 1 by definition
// subsequent values are the result of adding the previous two values together
// e.g value 3 is 2 (1 + 1)
// value 4 is 3 - (2 + 1)
// value 5 is 5 etc.
// expressesed mathematically
// F(1) = 1
// F(2) = 1
// F(n) = F(n - 1) + F(n - 2) where n > 2
