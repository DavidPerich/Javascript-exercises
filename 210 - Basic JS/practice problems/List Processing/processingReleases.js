...
function processReleaseData(data) {
  validMovies = data.filter(isValidMovie);
  return validMovies.map(idAndTitle);
}

function isValidMovie(movieData) {
  return movieData.id && movieData.title
}

function idAndTitle(movieData) {
  return {
    id: movieData.id,
    title: movieData.id,
  }
