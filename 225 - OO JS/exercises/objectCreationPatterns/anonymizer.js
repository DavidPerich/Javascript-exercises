...
var Account = (function () {
  ...
  return {
    ...
    firstName: function firstName(password) {
    ...
    lastName: function lastName(password) {
      if (validPassword(password)) {
        return userLastName;
      } else {
        return "Invalid Password";
...
var david = Object.create(Account).init("david@perich.com", "Origami", "David", "Perich");
console.log(fooBar.firstName("Origami"));
console.log(david.firstName("Origami"));